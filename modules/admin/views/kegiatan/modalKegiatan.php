            ...
            <div class="modal-body">
              <form id="form_kegiatan" >
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="kegiatan" name="kegiatan" placeholder="Masukkan Judul Kegiatan">
                </div>
				<div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="deskripsi" name="deskripsi" rows="5" placeholder="Masukkan Deskripsi Kegiatan"></textarea>
                </div>
				<div class="form-group">
                    <label for="exampleInputEmail1">Mulai</label>
                    <input type="text" class="form-control" id="start_date" name="start_date" placeholder="Mulai Kegiatan" autocomplete="off">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Selesai</label>
                    <input type="text" class="form-control" id="end_date" name="end_date" placeholder="Selesai Kegiatan" autocomplete="off">
                </div>
